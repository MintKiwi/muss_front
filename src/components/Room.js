...
const Room = () => {
  ...
  const getRoomDetails = () => {
    ...
    axios.get('http://ppsw.herokuapp.com/api/get-room' + "?code=" + roomCode)
      .then((response) => {
 ...
 const getCurrentSong=()=>{
  ...
  axios.get('http://ppsw.herokuapp.com/spotify/current-song')
   .then((response)=>{
     if(!response.ok){
       return {};
     }
...
// }
  ...
  const leaveButtonPressed = () => {
    ...
    axios.post('http://ppsw.herokuapp.com/api/leave-room'
  ...
  const authenticateSpotify=()=>{
    ...
    //  fetch('/spotify/is-authenticated')
    axios.get('http://ppsw.herokuapp.com/spotify/is-authenticated')
     .then((response)=>response.json()).then((data)=>{
      setState({...state,spotifyAuthenticated:data.status,})
      // console.log(state);
      if(!data.status){
        // fetch('/spotify/get-auth-url')
        axios.get('http://ppsw.herokuapp.com/spotify/get-auth-url')
        .then((response)=>response.json()).then((data)=>{
          window.location.replace(data.url);
        })
      }
