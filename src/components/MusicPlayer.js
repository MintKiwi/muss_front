...
const MusicPlayer=(prop)=>{
    ...
    const pauseSong=()=>{
        ...
        axios.put('http://127.0.0.1:8000/spotify/pause-song',requestOptions)
    ...
    const playSong=()=>{
        ...
        axios.put('http://127.0.0.1:8000/spotify/play-song',requestOptions)
    ...
    const skipSong=()=>{
        ...
        axios.put('http://127.0.0.1:8000/spotify/skip-song',requestOptions)
