...
const MusicPlayer=(prop)=>{
    ...
    const pauseSong=()=>{
        ...
        axios.put('https://ppsw.herokuapp.com/spotify/pause-song',requestOptions)
    ...
    const playSong=()=>{
        ...
        axios.put('https://ppsw.herokuapp.com/spotify/play-song',requestOptions)
    ...
    const skipSong=()=>{
        ...
        axios.put('https://ppsw.herokuapp.com/spotify/skip-song',requestOptions)
